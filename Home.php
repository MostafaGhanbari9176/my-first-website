...
<div id="myCarousel" class="carousel slide">
    ...
    <div class="carousel-inner">
        <div class="carousel-item active">
            <img class="first-slide carousel-img" src="helper/img/1.jpg" alt="First slide">
            <div class="container">
...
<div class="container marketing">
    ...
    <div class="row" style="text-align: center ; margin-top: 64px" id="downloadObjectRow">
        <script>
            address = '<?php require_once 'helper/StData.php';echo StData::$baseUrl; ?>getDownloadObject/home';
                const includeDestination = document.getElementById('downloadObjectRow');
        ...
        <div class="col-lg-4">
            <img class="rounded-circle small-img" src="helper/img/5.jpg" alt="Generic placeholder image">
            <h2>Heading</h2>
